...
/**
 * @brief Tests the functionality of the memory manager.
 *
 * This function performs various tests on the memory manager to ensure its correct operation,
 * including testing device pool eviction to host, host pool eviction to disk, manual eviction to disk,
 * and deletion of disk data on restore.
 
void testMemoryManager()* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
