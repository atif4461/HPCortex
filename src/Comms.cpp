...
/**
 * @brief Sets up the DDP communicator by establishing a shared understanding of pipeline ranks among processes.
 *
 * This function initializes the DDP communication infrastructure by first sharing the mapping between pipeline ranks and world ranks across all processes.
 * It then identifies the pipeline leaders and creates a new group consisting of these leaders for the batch communicator.
 * Finally, it ensures that all ranks within a pipeline are aware of their corresponding DDP rank and the total number of DDP ranks, regardless of whether they belong to the DDP group or not.
...
/**
 * Frees communicators used in the pipeline.
 *
 * Releases resources associated with the ddp_comm and pipeline_comm communicators,
 * ensuring proper cleanup and deallocation of MPI communication objects.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Creates a new communicator that includes only the process with the specified rank.
 * @param world_rank The rank of the process to be included in the new communicator.
 * @param comm The newly created communicator.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Enables DDP without pipelining internally by duplicating the global communicator 
 * and setting up a new communicator for the current process.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Initializes Communicators object with command line arguments.
 * 
 * This constructor initializes the MPI environment, sets error handling, 
 * determines global and node-local ranks, and configures the communicator 
 * hierarchy for Distributed Data Parallelism (DDP).
 *
...
/**
 * Destructor for Communicators class, releases all allocated resources and finalizes MPI environment. 
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Enables node pipelining by freeing existing communicators, creating a new subcommunicator 
 * that spans the current node, and setting up the DDP communicator.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Enables global pipelining by duplicating the world communicator and setting up 
 * the necessary communication infrastructure for pipeline parallelism.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Disables parallel execution by freeing communicators and reinitializing 
 * communication structures for single rank operation.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Enables DDP without pipelining by freeing communicators and then internally enabling the DDPnoPipelining mode.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Reports setup information for the current process.
 *
 * Iterates over all ranks in the global communicator, printing detailed rank information
 * for this process at its corresponding iteration.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @return Reference to internal Communicators instance
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Returns the global Communicators instance.
 *
 * @return Reference to the global Communicators object.
 * @throws std::runtime_error If the global Communicators instance has not been initialized.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
Communicators & communicators(){
...
/**
 * Initializes communication subsystem with command line arguments.
 *
 * @param argc Number of command line arguments
 * @param argv Array of command line argument strings
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
