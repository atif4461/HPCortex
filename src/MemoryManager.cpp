...
/**
 * @brief Allocates memory by mapping an anonymous region.
...
/**
 * @brief Frees memory mapped by mmap
 * @param pv pointer to memory region to be freed
 * @param byte_size size of memory region in bytes
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Allocates memory entry with specified byte size within designated pool.
 *
 * @param bytes Number of bytes required for allocation.
 * @param pool Type of memory pool where allocation should occur.
 *
 * @return Iterator pointing to newly allocated memory entry.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Performs sanity check on memory pools to ensure data integrity.
 *
 * Verifies that all entries in the free pools have correct byte sizes and 
 * checks for any corruption by comparing the expected and actual number 
 * of entries in the lists.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Moves an entry from a specified pool to the free pool.
 *
 * @param it Iterator pointing to the entry to be moved.
 * @param pool The pool where the entry currently resides.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Frees a previously allocated memory entry.
 *
 * This function releases the memory associated with the given iterator and updates the allocation tracking variables accordingly.
 *
 * @param it Iterator pointing to the entry to be freed.
 * @param pool The memory pool where the entry resides (either DevicePool or HostPool).
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Deallocates free memory from a specified pool until a target allocation level is reached.
 * 
 * This function iteratively frees memory blocks from the largest available entries in the pool,
 * removing empty entry lists as necessary, until the desired allocation threshold is met or exceeded.
 *
 * @param pool The memory pool from which to deallocate free memory.
 * @param until_allocated_lte The maximum amount of memory to leave allocated in the pool.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Retrieves an entry of specified size from the memory manager.
 *
 * This function attempts to retrieve an entry of the requested size from the memory pool.
 * It first checks if there is an available entry in the free pool, then tries to allocate new memory,
 * frees up unused blocks from the free pool if necessary, and finally evicts old data to make room.
 *
 * @param bytes The size of the entry to be retrieved.
 * @param pool The memory pool from which to retrieve the entry.
 *
 * @return An iterator pointing to the retrieved entry.
 *
 * @throws std::runtime_error If the requested size exceeds the maximum pool size or if the memory manager fails to retrieve an entry.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Attaches an entry to a memory handle in the specified pool.
 * 
 * @param handle Reference to the memory handle to attach the entry to.
 * @param pool The pool where the entry should be attached (DevicePool or HostPool).
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Updates the position of a memory entry within its associated pool.
 *
 * @param[in,out] handle Reference to the handle containing the entry to be updated.
 * @param[in]     pool The pool where the entry resides.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Synchronizes the device memory with the host memory for a given handle.
 *
 * This function ensures that the data stored in the device memory is copied to the host memory,
 * maintaining consistency between the two. It first checks if the handle is initialized and
 * if the device copy is valid and in sync. If necessary, it attaches the entry to the host pool
 * before performing the synchronization using acceleratorCopyFromDevice.
 *
 * @param[in,out] handle The handle associated with the memory region to be synchronized.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Synchronizes the host memory with the device memory for a given handle.
 *
 * This function ensures that the host copy is valid and in sync before performing the synchronization.
 * If the device entry does not exist, it attaches the handle to the device pool.
 * The function then performs an accelerator-based copy from the host to the device.
 *
 * @param[in,out] handle Handle object containing information about the memory region to be synchronized.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Synchronize host memory to disk storage.
 *
 * This method ensures that the data stored in the host memory is written to the disk,
 * maintaining consistency between the two. It checks for initialization and validity
 * of the host data before performing the synchronization operation.
 *
 * @param[in,out] handle Reference to the Handle object containing metadata about the data region.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Removes disk data associated with the specified handle.
 *
 * This function checks if the disk file exists before attempting to remove it.
 * If in_memory_check is true, it ensures that either the host or device has a copy of the data in memory before deletion.
 * The function updates the local disk allocation and handle status accordingly.
 *
 * @param[in,out] handle Handle referencing the disk data to be removed
 * @param[in] in_memory_check Flag indicating whether to check for in-memory copies before deletion
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Synchronize disk data with host memory.
 *
 * This function ensures that the data stored on disk is up-to-date and reflects the current state of the system.
 * It checks the validity of the handle and throws exceptions if necessary.
 * If the host entry is not valid, it attaches the handle to the host pool.
 * The function then reads the data from disk and updates the host entry accordingly.
 *
 * @param[in,out] handle Handle object containing information about the data region to synchronize.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Synchronizes memory for reading purposes.
 *
 * Ensures that the specified handle is up-to-date with respect to the given pool,
 * performing necessary synchronizations between host, device, and disk as required.
 *
 * @param handle Reference to the handle to be synchronized.
 * @param pool The pool type indicating where synchronization should occur.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Marks a memory handle for write access within a specified pool.
 *
 * This method updates the synchronization status of the given handle based on the target pool,
 * ensuring data consistency across host, device, and disk storage.
 *
 * @param handle Reference to the handle to be marked for write access.
 * @param pool The pool where the write operation will take place, either HostPool or DevicePool.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Prepares an entry for viewing by checking its validity and updating its status accordingly.
 * @param handle Reference to the handle associated with the entry.
 * @param pool The memory pool where the entry resides.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Evicts an entry from the specified pool and optionally frees its associated memory.
 *
 * This function removes the specified entry from the memory manager's internal data structures,
 * detaches any handles that own the entry, and updates the corresponding synchronization flags.
 * If requested, the function also deallocates the entry's memory.
 *
 * @param[in] entry The iterator pointing to the entry to be evicted.
 * @param[in] free_it Flag indicating whether to deallocate the entry's memory.
 * @param[in] pool The pool from which the entry should be evicted.
 *
 * @return An iterator pointing to the next element in the pool after removal of the evicted entry.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Outputs a summary of memory pool status to an output stream.
 * @param os Output stream where the summary will be written.
 * @param descr Description of the memory pool being summarized.
 * @param pool_stat Map containing memory pool statistics, with keys representing block sizes in bytes and values representing lists of entries of that size.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param os Output stream where the summary will be written.
 * @param descr Description of the memory pool being summarized.
 * @param pool_stat Map containing size and count information about the memory pool, sorted by size in descending order.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Destructor for MemoryManager class, responsible for releasing all allocated resources.
 * Cleans up memory pools by freeing entries in device and host pools, then deallocates the pools themselves.
 * Additionally, deletes the io_logger object if it exists.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Returns the total number of bytes cached on disk.
 *
 * This method iterates over all memory handles and sums up the bytes of those that are initialized,
 * not synchronized with device or host, and have a valid disk file associated with them.
 *
 * @return The total number of bytes cached on disk.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Generates a report on memory consumption and allocation status.
 *
 * This function provides information about the current memory usage,
 * including device, host, and disk memory allocations. It also reports
 * the high water mark values for these allocations. If the detailed flag
 * is set to true, additional information about free and in-use pools for
 * both device and host memories is included in the report.
 *
 * @param[in] detailed Flag indicating whether to include detailed pool status information.
 * @return A string containing the formatted memory consumption report.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Manually evicts data associated with the given handle to disk.
 *
 * @param h HandleIterator referencing the data to be evicted
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Decrements the lock entry of a handle iterator.
 * 
 * This method checks if the current execution is within a thread parallel region and throws an exception if so.
 * It also verifies that the lock entry of the handle iterator has not been previously decremented to zero.
 *
 * @param h Handle iterator whose lock entry is to be decremented.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
