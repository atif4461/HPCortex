...
/**
 * Constructor for scaled dot product attention component.
 * Initializes dimensions of query and value vectors and scaling factors.
 * @param d_k Dimension of key vector
