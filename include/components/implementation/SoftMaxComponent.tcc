/**
 * @brief Computes the softmax value of the input tensor along the specified dimension.
 *
 * This function calculates the softmax activation function for the given input tensor,
 * which is commonly used in machine learning models, particularly in the output layer
 * of classification problems. The softmax function maps the input values to a probability distribution,
 * where the probability of each class is proportional to the exponential of the input value.
 *
 * @param in Input tensor to compute the softmax value for.
 * @return A new tensor containing the computed softmax values.
...
/**
 * @brief Computes the derivative of the cost with respect to the input of the SoftMax component.
 *
 * This function calculates the derivative of the cost with respect to the input,
 * which is used in backpropagation during neural network training.
 *
 * The computation involves calculating the layer derivative, which is then used to update the input gradient.
 *
 * @param _dcost_by_dOut The derivative of the cost with respect to the output of the SoftMax component.
 * @param[out] dcost_by_dIn The derivative of the cost with respect to the input of the SoftMax component.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
template<typename FloatType, int TensDim>
