...
/**
 * @brief Component implementing the softmax activation function.
 *
 * This component applies the softmax transformation along a specified dimension,
 * which is commonly used in machine learning models, particularly in output layers.
