...
/**
 * @brief Constructs a layer performing multi-head self attention operation
 * @param u Input data to be processed by the layer
 * @param Nheads Number of attention heads
 * @param W_Q Query weight matrices
 * @param W_K Key weight matrices
 * @param W_V Value weight matrices
 * @param W_O Output weight matrix
 * @return Layer object representing the constructed multi-head self attention layer
