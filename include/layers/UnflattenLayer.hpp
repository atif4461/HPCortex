...
/**
 * @brief Represents a layer that unflattens its input data.
 *
 * This class provides functionality for unflattening input tensors,
 * computing forward passes, calculating derivatives, updating parameters,
