...
/**
 * @brief Constructor for a deep neural network layer.
 * @param leaf Store object containing input data.
 * @param weights Weight matrix for the layer.
 * @param bias Bias vector for the layer.
 * @param activation_func Activation function used by the layer.
