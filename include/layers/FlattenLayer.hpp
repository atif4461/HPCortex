...
/**  * @brief Represents a layer that flattens its input tensor.
 *
 * This class provides functionality for performing forward passes,
 * computing derivatives, updating parameters, and managing memory.
