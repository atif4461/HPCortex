...
public:
/**
 * @brief Wrapper class around PipelineBlockType to calculate batch pipeline costs
 * @details Provides functionality to compute costs associated with pipeline blocks
 *         considering batch size and communication ranks
...
/**
 * @brief Computes the loss between predicted and actual outputs across multiple iterations.
 *
 * This function calculates the total loss by iterating over batches of input data,
 * computing predictions, and accumulating losses. It also computes derivatives
 * with respect to model parameters and broadcasts the final results across ranks.
 *
 * @param x Input data
 * @param y Actual output data
...
/**
 * Retrieves model parameters as a vector.
 *
 * @return Vector of FloatType containing model parameters
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Predicts output values for a given input matrix.
 *
 * This function takes an input matrix x and generates predicted output values.
 * It processes the input data in batches and utilizes parallel processing
 * across multiple ranks to achieve efficient computation.
 *
 * @param x Input matrix with dimensions size(0) x size(1).
 * @return Predicted output matrix with dimensions size(0) x global_batch_size.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
public:
/**
 * @brief Wrapper class around PipelineBlockType providing additional functionality
 * @details Manages pipeline block costs and derivatives with optional custom cost function
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
public:
/**
 * Initializes pipeline communicator with rank information.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Waits for all pending communication requests to complete.
 *
 * @param[in] reqs Vector of communication requests to wait for
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Sends a matrix to another process asynchronously.
 *
 * @param mat Matrix to be sent
 * @param to Rank of the destination process
 * @return Communication request object representing the ongoing operation
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
  template<typename T>
...
/**
 * @brief Receives data from another process and returns a communication request object.
 * @param mat Matrix to receive data into
 * @param from Rank of the process sending the data
 * @return Communication request object representing the reception operation
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
  template<typename T>
...
/**
 * @brief Handles leftward data transfer between processes in a pipeline.
 *
 * This method manages the sending and receiving of data to and from neighboring processes
 * in a pipeline, depending on the current process's position and rank.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Performs rightward data transfer along the pipeline.
 *
 * This method handles the passing of data to the right neighbor in the pipeline,
 * taking into account whether this node is the first, last, or an intermediate node.
 *
 * @param[in,out] reqs Vector of communication requests to be executed.
 * @param[in] send_first Data to be sent to the next rank if this node is the first node.
 * @param[in] send_bulk Data to be sent to the next rank if this node is not the first or last node.
 * @param[out] recv_bulk Data received from the previous rank if this node is not the first node.
 * @param[out] recv_last Data received from the previous rank if this node is the last node.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
  template<typename T, typename U>
...
/**
 * @brief Handles data transfer between pipeline stages by sending or receiving data as necessary.
 *
 * This function facilitates communication between consecutive stages in a multi-stage pipeline,
 * ensuring that data is properly propagated through the pipeline.
 *
 * @param[in,out] reqs vector of CommsRequests to be processed
 * @param[in] send_last pointer to the last element to be sent
 * @param[out] recv_first pointer to the first element to be received
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
  template<typename T>
...
/**
 * @brief Constructor for initializing the pipeline block with block store, output dimensions, and input dimensions.
 * 
 * Initializes the block object by moving the provided block store, copying the output and input dimensions, 
 * computing parameter information, calculating block parameter offsets, determining total parameters, 
 * setting up storage for previous block inputs and derivatives, and resizing the block's input buffer.
 *
 * @param _block The block store to be moved into this object.
 * @param block_output_dims_ Array of integers representing the output dimensions of the block.
 * @param block_input_dims_ Array of integers representing the input dimensions of the block.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
