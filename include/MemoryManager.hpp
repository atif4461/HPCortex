...
/**
 * @brief Constructor for memory management class
 * Initializes memory allocation tracking variables for device, host, and local disk
 * Sets default values for maximum pool sizes, verbosity, and disk root directory
...
/**
 * @brief Constructor for memory management initialization
 * @param max_size_device Maximum size of device memory pool
 * @param max_size_host Maximum size of host memory pool
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Returns a reference to the globally accessible memory pool instance.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
